...
class CustomTracksTab(QWidget):
    ...
    def __init__(self, character_data: Dict[str, Any], parent: QWidget = None):
        ...
        self.cards: List[CustomTrackCard] = []
        self.init_ui()
    ...
    def init_ui(self) -> None:
        ...
        self.add_btn.setStyleSheet("""
            QPushButton { border: 2px dashed #554477; color: #554477; font-weight: bold; border-radius: 10px; font-size: 11pt; }
    ...
    def prompt_add_card(self) -> None:
        """弹出对话框询问轨道长度"""
        length, ok = QInputDialog.getInt(
            self, "添加轨道", "请输入轨道格数 (例如 15, 30, 5):", 
    ...
    def get_data(self) -> Dict[str, List[Dict[str, Any]]]:
        return {"custom_tracks": [card.get_data() for card in self.cards]}